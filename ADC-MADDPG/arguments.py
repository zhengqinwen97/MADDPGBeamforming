...
def parse_args():
    ...
    parser.add_argument("--max_episode", type=int, default=5000, help="maximum episode length")
...
#     parser.add_argument("--train_model", type=str, default='n', help="swhich model to be trained")
    ...
    parser.add_argument("--learning_fre", type=int, default=8, help="learning frequency")
