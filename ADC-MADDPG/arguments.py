...
def parse_args():
    ...
    parser.add_argument("--max_episode", type=int, default=800, help="maximum episode length")
...
#     parser.add_argument("--train_model", type=str, default='n', help="swhich model to be trained")
    ...
    parser.add_argument("--learning_start_step", type=int, default=100, help="learning start steps") # 5000
